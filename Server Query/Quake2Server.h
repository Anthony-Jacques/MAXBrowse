...
class Quake2Server : public Quake3Server
{
public:
	Quake2Server(const idStr &host, const unsigned short port)
		: Quake3Server(host, port)
	{
	}

	virtual const char *GetBaseGameCvar() const { return "game"; }
	virtual const char* GetBaseGame() const { return "baseq2"; }
	virtual const char* GetMaxClientsCVar() const { return "maxclients"; }	// fixme, this is wrong - its in the xml file too
